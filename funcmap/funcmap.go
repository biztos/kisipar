...
// Package funcmap provides functions useful to html templates, and a standard
// html.FuncMap of them.
//
...
// New returns a function map containing all the available functions,
// mapped to names as shown in the documentation above.
